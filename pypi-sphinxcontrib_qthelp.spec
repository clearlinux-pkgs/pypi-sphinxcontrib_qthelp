...
Source0  : https://files.pythonhosted.org/packages/ac/29/705cd4e93e98a8473d62b5c32288e6de3f0c9660d3c97d4e80d3dbbad82b/sphinxcontrib_qthelp-1.0.7.tar.gz
...
%prep
%setup -q -n sphinxcontrib_qthelp-1.0.7
cd %{_builddir}/sphinxcontrib_qthelp-1.0.7
pushd ..
cp -a sphinxcontrib_qthelp-1.0.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705166292
