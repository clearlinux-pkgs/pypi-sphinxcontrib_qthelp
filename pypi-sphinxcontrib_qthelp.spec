...
Source0  : https://files.pythonhosted.org/packages/68/bc/9104308fc285eb3e0b31b67688235db556cd5b0ef31d96f30e45f2e51cae/sphinxcontrib_qthelp-2.0.0.tar.gz
...
%prep
%setup -q -n sphinxcontrib_qthelp-2.0.0
cd %{_builddir}/sphinxcontrib_qthelp-2.0.0
pushd ..
cp -a sphinxcontrib_qthelp-2.0.0 buildavx2
popd
pushd ..
cp -a sphinxcontrib_qthelp-2.0.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740086110
...
cp %{_builddir}/sphinxcontrib_qthelp-%{version}/LICENCE.rst %{buildroot}/usr/share/package-licenses/pypi-sphinxcontrib_qthelp/fc88bdd02ddfd29b245693fb34c3a9e6feee3dab || :
